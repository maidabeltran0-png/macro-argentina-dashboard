...
# ── BCRA API ──────────────────────────────────────────────────────────────────
BCRA_BASE_URL = "https://api.bcra.gob.ar/estadisticas/v3"
BCRA_TIMEOUT_SECONDS = 10
BCRA_MAX_RETRIES = 3
BCRA_BACKOFF_SECONDS = 2.0

# BCRA series IDs — verify against https://api.bcra.gob.ar/estadisticas/v3/
# before first run. These IDs have changed historically.
BCRA_SERIES = {
    ...
    "tasa_politica_monetaria": "6",    # Tasa de política monetaria (% TNA)
